"""Documentation Agent - Main Agent Implementation."""
...
class DocumentationAgentAgent:
    ...
    def __init__(self):
        ...
        self.architecture_diagrams_enabled = True
        self.changelog_generation_enabled = True
        self.staleness_detection_enabled = True
        self.onboarding_guides_enabled = True
        self._tool_dispatch = {
            "generate_api_docs": self.tools.generate_api_docs,
            "generate_architecture_diagram": self.tools.generate_architecture_diagram,
            "generate_changelog": self.tools.generate_changelog,
            "detect_stale_docs": self.tools.detect_stale_docs,
            "generate_onboarding_guide": self.tools.generate_onboarding_guide,
            "generate_docstrings": self.tools.generate_docstrings,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['api_docs', 'architecture_diagrams', 'changelog_generation', 'staleness_detection', 'onboarding_guides'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "detect_stale_docs": ['detect', 'stale', 'docs'],
            "generate_onboarding_guide": ['generate', 'onboarding', 'guide'],
